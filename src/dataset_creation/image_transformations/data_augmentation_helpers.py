...
def random_rotation(image, rotation_range, channel_axis=2, fill_mode='nearest', cval=255, interpolation_order=1):
    """
    Introduces random rotation to given image
...
def apply_affine_transform(x, theta=0, row_axis=0, col_axis=1, channel_axis=2, fill_mode='constant', cval=255, order=1):
    """
